 ...
 * Generated C source from "src/HBTui_HBoxLayout.prg"
 */
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_HBTUI_HBOXLAYOUT )
{ "HBTUI_HBOXLAYOUT", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HBTUI_HBOXLAYOUT )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_HBTUI_HBOXLAYOUT, "src/HBTui_HBoxLayout.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_HBTUI_HBOXLAYOUT
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_HBTUI_HBOXLAYOUT )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( HBTUI_HBOXLAYOUT )
{
   ...
   do {
	...
	hb_xvmModuleName( "src/HBTui_HBoxLayout.prg:HBTUI_HBOXLAYOUT" );
	hb_xvmSetLine( 7 );
	...
	hb_xvmPushStringConst( "HBTui_HBoxLayout", 16 );
	...
	hb_xvmPushStringConst( "New", 3 );
	{
		static const HB_BYTE codeblock[ 81 ] = {
			2, 0, 0, 0, 51, 115, 114, 99, 47, 72, 66, 84, 117, 105, 95, 72, 
			66, 111, 120, 76, 97, 121, 111, 117, 116, 46, 112, 114, 103, 58, 72, 66, 
			84, 85, 73, 95, 72, 66, 79, 88, 76, 65, 89, 79, 85, 84, 0, 37, 
			1, 0, 83, 69, 76, 70, 0, 37, 2, 0, 80, 65, 82, 69, 78, 84, 
			0, 48, 2, 0, 48, 6, 0, 95, 1, 112, 0, 121, 95, 2, 112, 2, 
			6 };
...
HB_FUNC_INITSTATICS()
{
   do {
	...
	hb_xvmSFrame( symbols + 14 );
	hb_xvmModuleName( "src/HBTui_HBoxLayout.prg:(_INITSTATICS)" );
	/* *** END PROC *** */
   } while( 0 );
}
...
{
   do {
	hb_xvmModuleName( "src/HBTui_HBoxLayout.prg:(_INITLINES)" );
	hb_xvmPushStringConst( "src/HBTui_HBoxLayout.prg", 24 );
	hb_xvmPushInteger( 0 );

 ...
 * Generated C source from "src/HBTui_TextEdit.prg"
 */
...
HB_FUNC( HBTUI_TEXTEDIT );
HB_FUNC_EXTERN( __CLSLOCKDEF );
HB_FUNC_EXTERN( HBCLASS );
HB_FUNC_EXTERN( HBTUI_WIDGET );
HB_FUNC_EXTERN( HBTUI_TEXTEDIT_NEW );
HB_FUNC_EXTERN( HBTUI_TEXTEDIT_PAINTEVENT );
...
HB_INIT_SYMBOLS_BEGIN( hb_vm_SymbolInit_HBTUI_TEXTEDIT )
{ "HBTUI_TEXTEDIT", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( HBTUI_TEXTEDIT )}, NULL },
{ "__CLSLOCKDEF", {HB_FS_PUBLIC}, {HB_FUNCNAME( __CLSLOCKDEF )}, NULL },
{ "NEW", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "HBCLASS", {HB_FS_PUBLIC}, {HB_FUNCNAME( HBCLASS )}, NULL },
{ "HBTUI_WIDGET", {HB_FS_PUBLIC}, {HB_FUNCNAME( HBTUI_WIDGET )}, NULL },
{ "ADDMETHOD", {HB_FS_PUBLIC | HB_FS_MESSAGE}, {NULL}, NULL },
{ "HBTUI_TEXTEDIT_NEW", {HB_FS_PUBLIC}, {HB_FUNCNAME( HBTUI_TEXTEDIT_NEW )}, NULL },
{ "HBTUI_TEXTEDIT_PAINTEVENT", {HB_FS_PUBLIC}, {HB_FUNCNAME( HBTUI_TEXTEDIT_PAINTEVENT )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_HBTUI_TEXTEDIT, "src/HBTui_TextEdit.prg", 0x0, 0x0003 )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup hb_vm_SymbolInit_HBTUI_TEXTEDIT
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( hb_vm_SymbolInit_HBTUI_TEXTEDIT )
   #include "hbiniseg.h"
#endif
...
HB_FUNC( HBTUI_TEXTEDIT )
{
   ...
   do {
	...
	hb_xvmModuleName( "src/HBTui_TextEdit.prg:HBTUI_TEXTEDIT" );
	hb_xvmSetLine( 7 );
	...
	hb_xvmPushStringConst( "HBTui_TextEdit", 14 );
	...
	hb_xvmPushStringConst( "Settext", 7 );
	{
		static const HB_BYTE codeblock[ 70 ] = {
			...
			101, 120, 116, 69, 100, 105, 116, 46, 112, 114, 103, 58, 72, 66, 84, 85, 
			73, 95, 84, 69, 88, 84, 69, 68, 73, 84, 0, 37, 1, 0, 83, 69, 
...
HB_FUNC_INITSTATICS()
{
   do {
	...
	hb_xvmSFrame( symbols + 19 );
	hb_xvmModuleName( "src/HBTui_TextEdit.prg:(_INITSTATICS)" );
	/* *** END PROC *** */
   } while( 0 );
}
...
{
   do {
	hb_xvmModuleName( "src/HBTui_TextEdit.prg:(_INITLINES)" );
	hb_xvmPushStringConst( "src/HBTui_TextEdit.prg", 22 );
	hb_xvmPushInteger( 0 );
